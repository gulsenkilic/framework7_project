...
Route::get('ogrenci/ekle2', [Controller::class, 'ogrenciekle2'])->name('ogrenciekle2');
Route::get('ogrenci/ekleform', [Controller::class, 'ogrenciekleform'])->name('ogrenciekleform');
Route::get('ogrenci/araform', [Controller::class, 'ogrenciaraform'])->name('ogrenciaraform');
