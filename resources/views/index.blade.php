  ...
  <div class="panel panel-left panel-reveal panel-resizable">
    <div class="page">
      <div class="page-content">
          ...
          <ul>
              <li>
                <a href="{{ route('index') }}" class="panel-close external">ANA SAYFA</a>
              </li>
              <li>
                <a href="{{ route('ogrenciaraform') }}" class=" external">OGRENCI ARA</a>
              </li>
              <li>
                <a href="{{ route('ogrenciekleform') }}" class="panel-close external">OGRENCI EKLE</a>
              </li>
              <li>
              <a href="#" class="panel-close external">KAPAT</a>
              </li>
          </ul>
          </div>
          </div>
      </div>
    <div class="panel-resize-handler"></div></div>
      </div>
    </div>
<div class="page">
<div class="navbar">
    ...
    <div class="navbar-inner sliding">
      ...
      <div class="right">
          <a class="link"  href="{{ route('ogrenciaraform') }}">OGRENCI ARA</a> 
      </div>
    </div>
  </div>
